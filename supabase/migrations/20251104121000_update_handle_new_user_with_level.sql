-- Update handle_new_user function to include level field
...
-- Add comment
COMMENT ON FUNCTION public.handle_new_user() IS 'Trigger function to create profile with level when a new user signs up';
